...
<h3><label>Eliminacion de Regsitros</label></h3>
...
$idBorrar = $row['id'];
             $borrar = "DELETE FROM registros WHERE id=$idBorrar";

               echo "<tr>". "<form id='formulario_bajas' method='post' action='bajasController.php'>".
              ...
              "<td>" ."<img src='".$row["imagen"]."' width='50' height='50'>". "</td>".
                "<td>" . "<button type='submit' class='btn btn-danger btn-block' name='button' value='".$row["id"]."' id='btnEliminar'>Eliminar</button> " . "</td>".
                "</form>". "</tr>";
